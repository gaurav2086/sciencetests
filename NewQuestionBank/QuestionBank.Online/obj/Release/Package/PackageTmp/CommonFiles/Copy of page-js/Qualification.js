...
$(document).ready(function () {
    ...
    function EditQualification(btn) {
        ...
        $("#txtQualification").val($(btn).parent().parent().find("td")[1].innerHTML);
    ...
    function SaveQualification() {
        var InputXMLParam = "<Root><QualificationID>" + $("#QualificationID").val() + "</QualificationID><QualificationName>" + $("#txtQualification").val() + "</QualificationName><IsActive>" + $("#chkIsActive").prop("checked") + "</IsActive></Root>";
        $.ajax({
            type: "POST",
