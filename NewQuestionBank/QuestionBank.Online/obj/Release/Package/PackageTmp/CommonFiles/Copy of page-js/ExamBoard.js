...
function EditExamBoard(btn) {
    ...
    $("#txtExamBoard").val($(btn).parent().parent().find("td")[1].innerHTML);
...
function SaveExamBoard() {
    var InputXMLParam = "<Root><ExamBoardID>" + $("#ExamBoardID").val() + "</ExamBoardID><ExamBoardName>" + $("#txtExamBoard").val() + "</ExamBoardName><IsActive>" + $("#chkIsActive").prop("checked") + "</IsActive></Root>";
    $.ajax({
        type: "POST",
