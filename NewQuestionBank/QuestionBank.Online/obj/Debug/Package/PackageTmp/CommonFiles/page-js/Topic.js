...
function EditTopic(btn) {
    ...
    BindUnit($(btn).parent().parent().find("td")[10].innerHTML, $(btn).parent().parent().find("td")[8].innerHTML);

    $("#txtTopicName").val($(btn).parent().parent().find("td")[12].innerHTML)

    if ($(btn).parent().parent().find("td")[13].innerHTML == "true")
        $("#chkIsActive").prop("checked", true);
    else
