    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for (var i = 0; i < obj.Table1.length; i++) { // for loop start for Bind Qualification
                ...
                for (var j = 0; j < obj.Table2.length; j++) { // for loop start for Bind ExamBoard
                    ...
                    if (obj.Table1[i].QualificationID == obj.Table2[j].QualificationID) {
                        ...
                        ExamBoard += "<li ><a id='EBlnkMenu-" + obj.Table2[j].GQEMID + "-Subject-" + obj.Table2[j].ExamBoardName + "' href='frmExamBoardInfo.aspx?ExamBoardID=" + obj.Table2[j].GQEMID + "&ExamBoardName=" + obj.Table2[j].ExamBoardName + "'><span>" + obj.Table2[j].ExamBoardName + "</span></a>" + Subject + "</li>";
                    }
                ...
                Qualification += "<li><a  id='QlnkMenu-" + obj.Table1[i].QualificationID + "-ExamBoard-" + obj.Table1[i].Qualification + "'  href='frmExamBoardInfo.aspx?QualificationID=" + obj.Table1[i].QualificationID + "&QualificationName=" + obj.Table1[i].Qualification + "'><span>" + obj.Table1[i].Qualification + "</span></a>" + ExamBoard + "</li>";
            ...
            for (var s = 0; s < obj.Table4.length; s++) {
                CatgorySaubject += "<li><a  id='CatgorySaubject-" + obj.Table4[s].SubjectId + "-Category-" + obj.Table4[s].SubjectName + "'  href='frmExamBoardInfo.aspx?SubjectName=" + obj.Table4[s].SubjectName + "'><span>" + obj.Table4[s].SubjectName + "</span></a></li>";
            }
            CatgorySaubject += "</ul>";
            for (var k = 0; k < obj.Table.length; k++) {

                if (obj.Table[k].MenuId == '1') {
                    MainMenu += " <li class='has-sub'><a  id='AllQlnkMenu-" + obj.Table[k].MenuId + "-Qualification-" + obj.Table1[0].Qualification + "'   href='frmExamBoardInfo.aspx?Type=Qualification'><span>" + obj.Table[k].MenuName + "</span></a>" + Qualification + "</li>";


                }
                else if (obj.Table[k].MenuId == '2') {
                    MainMenu += " <li class='has-sub'><a  id='SubjectforCategory-" + obj.Table[k].MenuId + "-Category-Biology'   href='frmExamBoardInfo.aspx?Type=SubjectCategory'><span>" + obj.Table[k].MenuName + "</span></a>" + CatgorySaubject + "</li>";
                }
                else {
