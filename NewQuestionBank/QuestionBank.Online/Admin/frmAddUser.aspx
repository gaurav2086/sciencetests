<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmAddUser.aspx.cs" Inherits="QuestionBank.Online.Admin.frmAddUser" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" runat="server">
        ...
        <div class="col-lg-12">
            ...
            <div id="divUserList">
                <div style="overflow: auto">
                    <table class="table table-bordered table-hover table-condensed " id="tblUserList">
                        <thead>
                            <tr>
    ...
    <script src='<%= ResolveUrl("../CommonFiles/page-js/AddUser.js")%>' type="text/javascript"></script>
