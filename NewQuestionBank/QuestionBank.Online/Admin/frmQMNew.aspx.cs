...
{
    public partial class frmQMNew : System.Web.UI.Page
    {
        ...
        [WebMethod(EnableSession = true)]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json, UseHttpGet = false)]
        public static clsResponse Select_QuestionDetails_FillForUpdate(string inXML)
        {
            return ClsUICommon.CallToGateWay(Module.Admin, ActionType.Select_QuestionDetails_FillForUpdate, inXML, OutputType.JSON);
        }
