...
namespace QuestionBank.Online.OnlinePortal.Pages
{
    public partial class frmReport : System.Web.UI.Page
    {
        ...
        public static clsResponse GetReportDetails(string inXML)
        {
            return ClsUICommon.CallToGateWay(Module.Admin, ActionType.Select_ReportDetails, inXML, OutputType.JSON);
        }
    }
}